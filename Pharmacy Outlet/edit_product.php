...
<div class="header">
    ...
    <form action="update.php" method = "get">
		<strong> PRODUCT NAME </strong><br/> 
			<input name="product_name" type="text" value="<?php echo $product -> product_name;?>"> <br/><br/>
		<strong> PRODUCT PRICE </strong><br/>
			<input name="product_price" type="int" size="30" maxlenght="11" value="<?php echo $product -> product_price;?>"> <br/><br/>
